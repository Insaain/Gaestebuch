            ...
            Button(
                onClick = {
                    if (name.isBlank() && (arrivalDate == null || departureDate == null)) {
                        ...
                        Toast.makeText(context, "Date range cannot be empty!", Toast.LENGTH_SHORT).show()
                    } else {
        ...
        DateRangePickerModal(
            onDateRangeSelected = { dateRange ->
                ...
                if (startMillis != null && endMillis != null) {
                    arrivalDate = LocalDate.ofEpochDay(startMillis / (24 * 60 * 60 * 1000))
                    departureDate = LocalDate.ofEpochDay(endMillis / (24 * 60 * 60 * 1000))
                }
